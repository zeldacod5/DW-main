...
<?php   
    ...
    var_dump($pro_id);
     try{
     $requete = "UPDATE pro_id, pro_ref, pro_cat_id, pro_libelle, pro_description, pro_prix, pro_stock, pro_couleur, pro_bloque, pro_d_ajout, pro_d_modif FROM produits ";
...
<body>
  ...
  <fieldset>
    ...
    <div class="form-group">
      ...
      <?php 
      echo "<input type='text' class='form-control' id='cat' value='".$produit->pro_cat_id."'>";
      ?>
    </div>
    <div class="form-group">
      <label for="lib">Libellé</label>
      <?php 
      echo "<input type='text' class='form-control' id='lib' value='".$produit->pro_libelle."'>";
      ?>
    </div>
    <div class="form-group">
      <label for="ref">Description</label>
      <?php 
      echo "<input type='text' class='form-control' id='desc' value='".$produit->pro_description."'>";
      ?>
    </div>
    <div class="form-group">
      <label for="price">Prix</label>
      <?php 
      echo "<input type='text' class='form-control' id='price' value='".$produit->pro_prix."'>";
      ?>
    </div>
    <div class="form-group">
      <label for="stock">Stock</label>
      <?php 
      echo "<input type='text' class='form-control' id='stock' value='".$produit->pro_stock."'>";
      ?>
    </div>
      <div class="form-group">
        <label for="color">Couleur</label>
        <?php 
      echo "<input type='text' class='form-control' id='color' value='".$produit->pro_couleur."'>";
      ?>
    </div>
      <br>
        <?php
