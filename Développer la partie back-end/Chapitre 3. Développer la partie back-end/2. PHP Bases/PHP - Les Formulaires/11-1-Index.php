...
<body>
    ...
    <div class="row no-gutters">
        <div class="col-12 col-lg-8 mt-3 text-justify pr-5 pl-5">
            <h2 style=color:tomato>L'entreprise</h2>
            ...
            <h2 style=color:tomato>Qualité</h2>
            ...
            <h2 style=color:tomato>Devis gratuit</h2>
            <p>Vous pouvez bien sûr contacter pour de plus amples informations ou pour une demande d’intervention. Vous souhaitez un devis ? Nous vous le réalisons gratuitement.
               Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolores enim voluptatibus soluta perferendis exercitationem eum nisi nesciunt quod quidem
               , facilis, sequi explicabo illo ex consequatur amet quibusdam reprehenderit assumenda modi laborum placeat?, </p>
            </div>
                <aside class="col-12 col-lg-4 text-center pt-4 bg-warning"> <h2 style=color:yellow>[Colonne de droite]</h2>
                </aside>
    </div>
    </section>
    <footer>
